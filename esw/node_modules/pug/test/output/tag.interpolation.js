...
function template(locals) {
    ...
    pug_mixins["item"] = pug_interp = function(icon) {
        ...
        if (attributes.href) {
            pug_html = pug_html + "<a" + pug_attrs(attributes, false) + "><img" + (' class="icon"' + pug_attr("src", i true, false)) + "/>";
            block && block();
            pug_html = pug_html + "</a>";
        } else {
            pug_html = pug_html + "<span" + pug_attrs(attributes, false) + "><img" + (' class="icon"' + pug_attr("src", i true, false)) + "/>";
            block && block();
